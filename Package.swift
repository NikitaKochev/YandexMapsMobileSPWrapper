...
let package = Package(
    name: "YandexMapsMobileSPWrapper",
    platforms: [
        .iOS(.v12),
    ],
    products: [
        ...
        .library(
            name: "YandexMapsMobileSPWrapper",
            targets: ["YandexMapsMobileSPWrapper"]
        ),
    ],
    dependencies: [
        // Dependencies declare other packages that this package depends on.
        .package(
            url: "https://github.com/NikitaKochev/YandexMapsMobileSP",
            .exact("4.4.0")
        ),
    ],
    targets: [
        ...
        .target(name: "YandexMapsMobileSPWrapper",
                dependencies: [
                    .product(name: "YandexMapsMobileSP", package: "YandexMapsMobileSP"),
                ],
                linkerSettings: [
